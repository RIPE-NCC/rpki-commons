...
public class CertificateRepositoryObjectPrinterTest {
    ...
    public void shouldPrintRoa() {
        ...
        assertEquals("""
            ...
            Signing time: 2008-01-01T00:00:00Z
            ASN: AS65000
            Prefixes:
                10.32.0.0/12
                10.64.0.0/12 [24]
    ...
    public void shouldPrintCRL() {
        ...
        X509CrlBuilder builder = X509CrlTest.getCrlBuilder(now);
        builder.addEntry(BigInteger.TEN, now.minus(1, ChronoUnit.DAYS));
        builder.addEntry(BigInteger.valueOf(42), now.minus(3, ChronoUnit.DAYS));
