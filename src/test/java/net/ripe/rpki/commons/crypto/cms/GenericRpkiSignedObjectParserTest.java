...
public class GenericRpkiSignedObjectParserTest {
    ...
    void should_parse_aspa() throws IOException {
        ...
        assertThat(parser.getSigningTime()).isEqualTo(Instant.parse("2021-11-11T11:19:00+00:00"));
    }
    ...
    void should_parse_gbr() throws IOException {
        ...
        assertThat(parser.getSigningTime()).isEqualTo(Instant.parse("2016-08-19T12:10:32+00:00"));
    }
    ...
    void should_parse_manifest() throws IOException {
        ...
        assertThat(parser.getSigningTime()).isEqualTo(Instant.parse("2013-10-28T21:24:39+00:00"));
    }
    ...
    void should_parse_roa() throws IOException {
        ...
        assertThat(parser.getSigningTime()).isEqualTo(Instant.parse("2011-11-11T01:55:18+00:00"));
    }
