...
public class RequestNotPerformedResponsePayloadWrapper extends ProvisioningPayloadWrapper {
    ...
    protected RequestNotPerformedResponsePayloadWrapper(String sender, String recipient, NotPerformedError status, String description) {
